...
from attendance.views import MusicianList, JobList, TimeList, Analytics, JobView, MusicianView, AddJobView, AddRosterView, AddRehearsalView, RehearsalYearView, GigYearView
